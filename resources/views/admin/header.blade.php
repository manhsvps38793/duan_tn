<div class="adnews-sidebar">
    ...
    <div class="adnews-sidebar-section">
        <h3>Công cụ</h3>
        <a href="{{asset('/admin/quanlykho')}}" class="adnews-sidebar-item {{ request()->is('admin/quanlykho*') ? 'adnews-active' : '' }}"><i class="fas fa-warehouse"></i><span>Quản lý kho</span></a>
        <a href="{{asset('/admin/quanlyhinhanh')}}" class="adnews-sidebar-item {{ request()->is('admin/quanlyhinhanh*') ? 'adnews-active' : '' }}"><i class="fas fa-images"></i><span>Hình ảnh sản phẩm</span></a>
        <a href="{{asset('/admin/quanlykhachhang')}}" class="adnews-sidebar-item {{ request()->is('admin/quanlykhachhang*') ? 'adnews-active' : '' }}"><i class="fas fa-users"></i><span>Khách hàng</span></a>
        <a href="{{asset('/admin/quanlynguoidung')}}" class="adnews-sidebar-item {{ request()->is('admin/quanlynguoidung*') ? 'adnews-active' : '' }}"><i class="fas fa-user-cog"></i><span>Quản lý người dùng</span></a>
    </div>
    <div class="adnews-sidebar-section">
        <h3>Nội dung</h3>
        <a href="{{asset('/admin/quanlytintuc')}}" class="adnews-sidebar-item {{ request()->is('admin/quanlytintuc*') ? 'adnews-active' : '' }}"><i class="fas fa-newspaper"></i><span>Tin tức</span></a>
    </div>
    <div class="adnews-sidebar-section">
        <h3>Hệ thống</h3>
        <a href="{{asset('/admin/caidat')}}" class="adnews-sidebar-item {{ request()->is('admin/caidat*') ? 'adnews-active' : '' }}"><i class="fas fa-cog"></i><span>Cài đặt</span></a>
        <a href="{{asset('/admin/hotro')}}" class="adnews-sidebar-item {{ request()->is('admin/hotro*') ? 'adnews-active' : '' }}"><i class="fas fa-headset"></i><span>Hỗ trợ</span></a>
    </div>
</div>
<script>
